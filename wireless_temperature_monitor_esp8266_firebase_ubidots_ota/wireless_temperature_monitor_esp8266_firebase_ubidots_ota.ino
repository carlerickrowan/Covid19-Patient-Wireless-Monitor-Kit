...
const char* UBIDOTS_TOKEN = "BBFF-5XgAuK702uqnonQOdIUYhsbsT7mhDl";  // Put here your Ubidots TOKEN
...
void loop()
{
  ...
  ubidots.add("Temperature", celcius);  
  ubidots.add("Battery", battery_voltage);
